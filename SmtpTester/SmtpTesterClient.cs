...
namespace SmtpTester
{
	...
	public class SmtpTesterClient
	{
		...
		public async Task TestEmail(string server, int port, bool enableTls, string userName, string password,
			string from, string to, string cc = null, string bcc = null, string subject = null, string body = null)
		{
			ClearErrors();
